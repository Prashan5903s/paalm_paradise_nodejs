...
const permArr = require("../../util/perArr")
...
exports.getPermAllowAPI = async (req, res, next) => {
    try {
        ...
        const permsArr = await permArr(userId)

        if (permsArr.errorExist) {

            return errorResponse(res, permsArr.message, permsArr.data, permsArr.statusCode)
        }

        return successResponse(res, permsArr.message, permsArr.data, permsArr.statusCode)
