...
exports.getEventAPIController = async (req, res, next) => {
    try {
        ...
        const event = await Event.find({ created_by: userId })
...
exports.postEventControllerAPI = async (req, res, next) => {
    try {
        ...
        const { event_name, description, end_on_date, end_on_time, role_id, role_or_user, start_on_date, start_on_time, status, user_id, venue } = req.body;
...
exports.updateEventControllerAPI = async (req, res, next) => {
    try {
        ...
        await Event.findOneAndUpdate(({ created_by: userId, _id: id }), ({
            event_name,
            description,
            end_on_date,
            end_on_time,
